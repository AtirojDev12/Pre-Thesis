...
namespace EpicTransport {
    ...
    public class EosTransport : Transport {
        ...
        public int GetMaxBatchSize(int channelId) => P2PInterface.MaxPacketSize; // Use P2PInterface.MaxPacketSize as everything above will get fragmentated and will be counter effective to batching
